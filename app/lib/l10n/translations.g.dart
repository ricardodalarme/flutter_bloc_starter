...
class _TranslationsOnboarding$pages$0i0$En with OnboardingPageData {
  ...
  @override
  String get message => 'Welcome to Flutter Bloc Starter';
}
...
class _TranslationsOnboarding$pages$0i1$En with OnboardingPageData {
  ...
  // Translations
  @override
  String get title => 'What is Flutter Bloc Starter?';
  @override
  String get message =>
      'Flutter Bloc Starter is a project to speed up the bootstrapping of new Flutter projects. It already comes with a series of features ready to use, such as internationalization, themes, routes, state management, among others.';
}
...
class _TranslationsOnboarding$pages$0i2$En with OnboardingPageData {
  ...
  @override
  String get message =>
      'Ready to explore everything Flutter Bloc Starter has to offer? Let\'s get started!';
}
...
class _TranslationsOnboarding$pages$0i0$Pt
  ...
  @override
  String get message => 'Seja muito bem vindo ao Flutter Bloc Starter';
}
...
class _TranslationsOnboarding$pages$0i1$Pt
  ...
  // Translations
  @override
  String get title => 'O que é o Flutter Bloc Starter?';
  @override
  String get message =>
      'O Flutter Bloc Starter é um projeto para agilizar o bootstrapping de novos projetos Flutter. Ele já vem com uma série de funcionalidades prontas para uso, como internacionalização, temas, rotas, gerenciamento de estado, entre outros.';
}
...
class _TranslationsOnboarding$pages$0i2$Pt
  ...
  @override
  String get message =>
      'Pronto para explorar tudo o que o Flutter Bloc Starter tem a oferecer? Vamos começar!';
}
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'onboarding.pages.0.message':
        return 'Welcome to Flutter Bloc Starter';
      case 'onboarding.pages.1.title':
        return 'What is Flutter Bloc Starter?';
      case 'onboarding.pages.1.message':
        return 'Flutter Bloc Starter is a project to speed up the bootstrapping of new Flutter projects. It already comes with a series of features ready to use, such as internationalization, themes, routes, state management, among others.';
      case 'onboarding.pages.2.title':
        return 'Let\'s get started?';
      case 'onboarding.pages.2.message':
        return 'Ready to explore everything Flutter Bloc Starter has to offer? Let\'s get started!';
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'onboarding.pages.0.title':
        return 'Bem vindo!';
      case 'onboarding.pages.0.message':
        return 'Seja muito bem vindo ao Flutter Bloc Starter';
      case 'onboarding.pages.1.title':
        return 'O que é o Flutter Bloc Starter?';
      case 'onboarding.pages.1.message':
        return 'O Flutter Bloc Starter é um projeto para agilizar o bootstrapping de novos projetos Flutter. Ele já vem com uma série de funcionalidades prontas para uso, como internacionalização, temas, rotas, gerenciamento de estado, entre outros.';
      case 'onboarding.pages.2.title':
        return 'Vamos começar?';
      case 'onboarding.pages.2.message':
        return 'Pronto para explorar tudo o que o Flutter Bloc Starter tem a oferecer? Vamos começar!';
      case 'onboarding.doneButton':
        return 'Começar';
      case 'post.title':
        return 'Feed';
